...
$string['copy'] = 'Copiar';
$string['create_new_file'] = 'Crear un nuevo fichero';
...
$string['deleteallsubmissions'] = 'Borrar todos los envíos';
$string['delete_file_fq'] = 'borrar el fichero \'{$a}\' ?';
$string['delete_file_q'] = 'Borrar fichero?';
$string['depends_on_https'] = 'Use ws o wss dependiendo de si está usando http o https';
$string['description'] = 'Descripción';
$string['diff'] = 'dif';
$string['discard_submission_period'] = 'Descartar periodo de envío';
...
$string['incorrect_file_name'] = 'Nombre del fichero erróneo';
...
$string['menukeepfiles'] = 'Archivos para mantener';
$string['new'] = 'Nuevo';
$string['new_file_name'] = 'Nuevo nombre de fichero';
